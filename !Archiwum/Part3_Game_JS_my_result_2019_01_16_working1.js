...
function checkWinner(mark, TDindex, TRindex, color){
	...
	if (TRindex < 3) {
		...
		// Takimi elementami są elementy DIV którymi rodzicami są elementy TD o tym samym indeksie który jest przekazywany do naszej funkcji w argumencie.
		//
		// Następnie ustawiamy zmienną colorCounter na wartość 0. Zmienna ta będzie wykorzystywana do liczenia
